  ...
  <div className="max-w-screen-lg mx-auto p-5" data-aos="zoom-in">
    <div className="grid grid-cols-1 md:grid-cols-12 border">
        <div className="bg-gray-900 md:col-span-4 p-10 text-white">
            ...
            Established in 2009 in the Middle East, Exceed NetSec specializes in advanced IT security and network solutions. The company focuses on strengthening IT infrastructures for organizations through services like email security, network enhancement, disaster recovery strategies, and managed services.
            </p>
