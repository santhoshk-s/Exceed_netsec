            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-4 lg:gap-8 py-14 max-w-xs mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-full ">
                <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                  <div className="bg-white rounded-md w-[285px] mb-10"> 
                   <img src= {Logo} />
                    ...
                    {/* <p class="py-8 text-sm text-white lg:max-w-xs text-center lg:text-left">Established in 2009 in the Middle East, Exceed NetSec specializes in advanced IT security and network solutions. The company focuses on strengthening IT infrastructures for organizations through services like email security</p> */}
                    <div class="flex mt-4 space-x-4 justify-center lg:justify-start sm:mt-0 ">
                        <a href="javascript:;"  class="w-9 h-9 rounded-full bg-[#67F529] flex justify-center items-center hover:bg-indigo-600">
                        ...
                        <a href="javascript:;"  class="w-9 h-9 rounded-full bg-[#67e930] flex justify-center items-center hover:bg-indigo-600">
                ...
                <div class="lg:mx-auto text-center sm:text-left">
                    ...
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;"  class="text-white">Home</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-white">About Us</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-white">Help </a></li>
                        <li><a href="javascript:;"  class=" text-white">Sales</a></li>
                    </ul>
                </div>
                ...
                <div class="lg:mx-auto text-center sm:text-left">
                    ...
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;"  class="text-white">+971 555 696 711</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-white">+971 429 454 38</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-white">info@exceednetsec.com </a></li>
                        <li><a href="javascript:;"  class=" text-white">info@exceedme.com</a></li>
                    </ul>
                </div>
